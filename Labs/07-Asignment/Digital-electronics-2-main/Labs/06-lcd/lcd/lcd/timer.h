...
/** @brief Set overflow 4s, prescaler // 101 --> 1024 */
#define TIM0_overflow_1s()    TCCR0B &= ~(1<<CS01); TCCR0B |= (1<<CS02) | (1<<CS00);
/** @brief Enable overflow interrupt, 1 --> enable */
...
#define TIM2_overflow_512us()  TCCR2B &= ~((1<<CS22) | (1<<CS20)); TCCR2B |= (1<<CS21);
/** @brief Set overflow 1ms, prescaler 011 --> 64 */
#define TIM2_overflow_1ms() TCCR2B &= ~(1<<CS22); TCCR1B |= (1<<CS21) | (1<<CS20);
/** @brief Set overflow 2ms, prescaler 010 --> 128 */
#define TIM2_overflow_2ms()  TCCR2B &= ~((1<<CS22) | (1<<CS20)); TCCR2B |= (1<<CS21);
/** @brief Set overflow 4ms, prescaler 100 --> 256 */
#define TIM2_overflow_4ms()    TCCR2B &= ~((1<<CS21) | (1<<CS20)); TCCR2B |= (1<<CS22);
/** @brief Set overflow 1s, prescaler // 101 --> 1024 */
#define TIM2_overflow_1s()    TCCR2B &= ~(1<<CS21); TCCR2B |= (1<<CS22) | (1<<CS20);
/** @brief Enable overflow interrupt, 1 --> enable */
